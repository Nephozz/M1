...
| [] -> [elt]
| h::t -> if (ordre elt h) then elt::h::t else h::(insert ordre elt t) 
...
*)
let listStat = 
  let input = open_in "/mnt/c/Users/thoma/OneDrive/Documents/PF/TP2/nat2016.txt" in 
...
*)
let listStatHomme = 
  let input = open_in "/mnt/c/Users/thoma/OneDrive/Documents/PF/TP2/nathomme2016.txt" in
  let filebuf = Lexing.from_channel input in
  Parser.main Lexer.token filebuf
