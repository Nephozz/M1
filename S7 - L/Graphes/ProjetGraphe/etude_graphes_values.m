function [degre,degre_moyen,C,clust_moyen,nombre_clique,ordre_clique,nombre_connexe,ordre_connexe,A, nb_plus_court_chemins] = etude_graphes_values(Adj, matriceDistances)
    ...
    %% Plus court chemin 
    D = all_shortest_paths(sparse(double(Adj).*matriceDistances.^2), struct('algname', 'auto'));
